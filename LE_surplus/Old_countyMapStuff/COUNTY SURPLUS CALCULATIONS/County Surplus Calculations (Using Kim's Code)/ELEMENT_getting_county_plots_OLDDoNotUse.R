...
dataIn=CAN_County_bnf[year,2:18]
...
for(year in 1:87){
  ...
  dataIn=CAN_County_crop[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for(year in 1:87){
  ...
  dataIn=CAN_County_dep[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for(year in 1:87){
  ...
  dataIn=CAN_County_fert[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for(year in 1:87){
  ...
  dataIn=CAN_County_man[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for(year in 1:87){
  ...
  dataIn=CAN_County_pop[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for(year in 1:87){
  ...
  #combine haldimand and norfolk 
  dataIn = CAN_County_pop[year,2:18]+CAN_County_man[year,2:18]+CAN_County_bnf[year,2:18]+CAN_County_dep[year,2:18]+CAN_County_fert[year,2:18]-CAN_County_crop[year,2:18]
  dataIn = as.numeric(as.character(unlist(dataIn)))
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/surplus_',i,'.jpg'))
}
...
ggsave(thisplot,filename=paste0('IMAGES_withNewCode/crop_',i,'.jpg'))
}
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/fert_',i,'.jpg'))
}
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/man_',i,'.jpg'))
}
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/pop_',i,'.jpg'))
}
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/dep_',i,'.jpg'))
}
...
for (i in c(1931,2016)){
  ...
  ggsave(thisplot,filename=paste0('IMAGES_withNewCode/bnf_',i,'.jpg'))
}
