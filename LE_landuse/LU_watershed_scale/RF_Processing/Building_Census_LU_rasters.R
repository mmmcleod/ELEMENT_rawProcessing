...
global_LU_NC = "Historical_Land-Cover_Change_and_Land-Use_Conversions_Global_Dataset__RF_AREAVEG_Feature_Collection_best.ncd.nc"
...
ONT_shape <- spTransform(ONT_shape, proj4string(global_LU_C3crop_NC.stack)) 
ONT_shape = shift(ONT_shape,360)
USA_shape = shapefile('LE_USA.shp')
USA_shape <- spTransform(USA_shape, proj4string(global_LU_C3crop_NC.stack)) 
