...
save('results\DepoLoops_USA.mat')
shapewrite(S,'results\Atmosphericndeposition.shp');
...
%% Scale pre-1970 deposition using CDIAC's. emisions data 
...
CDIACdata=CDIACdata(string(CDIACdata.Var1)=='UNITED STATES OF AMERICA',:); % only looking at US
...
%%
save('results\N_AtmosphericDeposition_scaled.mat','AtmosphericDeposition_withCDIAC')
...
% % % % 36009
% % % subplot(3,1,1)
% % % plot(AtmosphericDeposition_withCDIAC(:,1),AtmosphericDeposition_withCDIAC(:,2),'LineStyle','-','Color','#0000ff','LineWidth',2)
% % % hold on
...
% % % title('x36009')
% % % legend('CDIAC weighted','Regular Global ','TREND')
% % % % 
% % % % 18113
% % % subplot(3,1,2)
% % % plot(AtmosphericDeposition_withCDIAC(:,1),AtmosphericDeposition_withCDIAC(:,50),'LineStyle','-','Color','#0000ff','LineWidth',2)
% % % hold on
...
% % % % 39123
% % % subplot(3,1,3)
% % % plot(AtmosphericDeposition_withCDIAC(:,1),AtmosphericDeposition_withCDIAC(:,30),'LineStyle','-','Color','#0000ff','LineWidth',2)
% % % hold on
