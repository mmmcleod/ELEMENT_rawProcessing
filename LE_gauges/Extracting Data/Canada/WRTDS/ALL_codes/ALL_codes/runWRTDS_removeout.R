...
file_name = c("17.16018403702")
file_nameS = c("17.16018403702_SRP") 

plot(y$Sample$Date,y$Sample$ConcAve,type="o",col="red")
...
#}
#elist<- list(x,y)
plot(elist[[2]]$Sample$Julian,elist[[2]]$Sample$ConcAve,type="o",col="red")
#--------------------------------------
