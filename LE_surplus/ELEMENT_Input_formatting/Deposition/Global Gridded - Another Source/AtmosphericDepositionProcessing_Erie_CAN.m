...
% Waterloo 
subplot(3,1,1) 
plot(AtmosphericDeposition_withHoulton(:,1),AtmosphericDeposition_withHoulton(:,1+1),'LineStyle','-','Color','#0000ff','LineWidth',2)
hold on 
...
title('WATERLOO')
legend('Houlton weighted','Regular Global ','Checkered GRW')

% Dufferin 
subplot(3,1,2) 
plot(AtmosphericDeposition_withHoulton(:,1),AtmosphericDeposition_withHoulton(:,2+1),'LineStyle','-','Color','#0000ff','LineWidth',2)
hold on 
...
subplot(3,1,3) 
plot(AtmosphericDeposition_withHoulton(:,1),AtmosphericDeposition_withHoulton(:,14+1),'LineStyle','-','Color','#0000ff','LineWidth',2)
hold on 
