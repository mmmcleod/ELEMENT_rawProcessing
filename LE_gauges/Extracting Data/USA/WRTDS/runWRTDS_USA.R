...
filePath="C:/Users/Meghan McLeod/Dropbox/BASULAB_meghan/Proposal/Lake Erie Data processing/LE_gauges/Extracting Data/USA/WRTDS/Input_cleaned"
outPath = "C:/Users/Meghan McLeod/Dropbox/BASULAB_meghan/Proposal/Lake Erie Data processing/LE_gauges/Extracting Data/USA/WRTDS/Output_wrtds"
setwd(filePath)
...
file_names = list.files(path = ".",pattern="clean_C.csv*")
file_names = unique(substr(file_names,1,8))
...
for (i in 1:length(file_names)){
  ...
  eList = modelEstimation(eList,edgeAdjust = TRUE, verbose = TRUE, run.parallel = FALSE,minNumObs = MNobs, minNumUncen = MNuncert) #-----<
